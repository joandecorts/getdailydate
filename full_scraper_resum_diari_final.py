...
try:
    from total_station_config import STATIONS, TODAY, DATA_DIR
    print("✅ Configuració importada correctament des de 'total_station_config.PY'")
...
def obtenir_info_estacio(codi_estacio):
    """Obtenir nom de l'estació des de total_station_config.py"""
